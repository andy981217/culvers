			...
			<table>
				<tr>
					...
					<td><input type="text" name="order_no"
						value="<%=d.getOrder_no()%>" readonly></td>
				</tr>
				<tr>
					<th>비회원 번호</th>
				...
				<tr>
					...
					<td><select name="menu2">
							<option value="<%=d.getMenu2()%>"><%=d.getMenu2()%></option>
							<option value="nochoice">선택안함</option>
							<option value="The Culvers Deluxe">The Culvers Deluxe</option>
							<option value="The Culvers Bacon Deluxe">The Culvers
								Bacon Deluxe</option>
							<option value="Sundaes">Sundaes</option>
							<option value="Concrete Mixer">Concrete Mixer</option>
							<option value="Crinkle Cut Fries">Crinkle Cut Fries</option>
				...
				<tr>
					...
					<td><select name="menu3">
							<option value="<%=d.getMenu3()%>"><%=d.getMenu3()%></option>
							<option value="nochoice">선택안함</option>
							<option value="The Culvers Deluxe">The Culvers Deluxe</option>
							<option value="The Culvers Bacon Deluxe">The Culvers
								Bacon Deluxe</option>
